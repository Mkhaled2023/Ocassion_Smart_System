...
//        return 'http://occation-smart-system.atwebpages.com';
        return 'http://127.0.0.1:8000';
    }

    public  static function getImageUrl($folder,$image){
        if($image){return BaseController::get_url() . '/public/images/'.$folder .'/'.$image;
        }else{return BaseController::get_url() . '/public/images/logo.png';}
    }

    public  static function getFileUrl($folder,$file){
        if($file){return BaseController::get_url() . '/public/files/'.$folder .'/'.$file;
        }else{return BaseController::get_url() . '/public/images/logo.png';}
    }
